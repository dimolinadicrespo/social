    ...
    <div class="card mb-3 border-0 shadow">
        <div class="card-body d-flex flex-column">
            <div class="d-flex align-items-center mb-2">
                <img class="rounded mr-3" width="40px" :src="status.user.avatar" alt="">
                <div>
        ...
        <div class="card-footer">
            <div v-for="comment in comments" class="mb-2">
                <div class="d-flex">
                    <img class="rounded mr-2 shadow-sm" :src="comment.user.avatar" width="32px" height="32px" :alt="comment.user.name">
            ...
            <form @submit.prevent="commentStatus" v-if="isAuthenticated">
                <div class="d-flex justify-content-start align-items-start">
                    <img class="rounded float-left mr-2 shadow-sm" :src="user.avatar" width="34px" :alt="user.name">
